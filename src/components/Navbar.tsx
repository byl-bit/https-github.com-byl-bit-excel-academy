    ...
    <nav className="sticky top-0 z-50 w-full transition-all duration-300 border-b border-white/10 bg-slate-950/95 backdrop-blur-xl shadow-2xl py-0">
      <div className="container flex h-14 sm:h-16 items-center justify-between">
        <div className="flex items-center gap-4 sm:gap-8">
          ...
          >
            <div className="h-10 w-10 sm:h-11 sm:w-11 relative transition-transform duration-300 rounded-full overflow-hidden shadow-sm bg-white border border-slate-100 flex items-center justify-center p-1">
              <img 
