  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 4.5 * 1024 * 1024) {
      setAlert({
        ...
        description:
          "Max file size is 4.5MB. For larger files, please host externally (e.g. Google Drive) and paste the link.",
        variant: "error",
      });
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (res.status === 404) {
          throw new Error(
            "Upload service unreachable (404). Please ensure the latest code is deployed.",
          );
        }
        throw new Error(
      ...
      setAlert({
        ...
        description: "File uploaded safely.",
        variant: "success",
      });
    } catch (err: any) {
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewBook({ ...newBook, videoUrl: e.target.value })
                }
              />
            </div>
          </div>
