...
import { CheckCircle, XCircle, Clock, User, ShieldAlert, Mail, GraduationCap, Hash, Fingerprint } from "lucide-react";
...
export function ResetApprovals({ requests, onApprove, onReject }: ResetApprovalsProps) {
    ...
    return (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {requests.map((req) => (
                <Card key={req.id} className="relative overflow-hidden border-none shadow-xl bg-white group hover:scale-[1.02] transition-all duration-300">
