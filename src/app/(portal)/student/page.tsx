      ...
      <div className="glass-panel overflow-hidden rounded-4xl shadow-sm relative group">
        ...
        <div className="relative z-10 p-8 sm:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="relative">
            ...
            <div
              className="absolute -bottom-2 -right-2 bg-emerald-500 w-6 h-6 rounded-xl border-4 border-white shadow-lg animate-pulse"
          ...
          <div className="text-center md:text-left flex-1 space-y-4">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-3 pt-2">
              <div className="glass-panel bg-white/40 px-5 py-2 rounded-2xl text-[11px] font-black uppercase tracking-widest border-white/50 flex items-center gap-3 text-slate-600 shadow-xs">
                <Award className="h-4 w-4 text-amber-500" /> ID:{" "}
                {user.studentId}
              </div>
              <div className="glass-panel bg-white/40 px-5 py-2 rounded-2xl text-[11px] font-black uppercase tracking-widest border-white/50 flex items-center gap-3 text-slate-600 shadow-xs">
        ...
        <Card className="lg:col-span-2 relative overflow-hidden group border-none shadow-sm h-full bg-white/40">
          ...
          >
            <Button
              ...
              size="sm"
              asChild
              className="rounded-xl text-blue-600 font-black text-[10px] uppercase tracking-widest hover:bg-blue-50"
            >
              <Link href="/student/results">
                Full Transcript <ArrowRight className="ml-2 h-3 w-3" />
              </Link>
            </Button>
          </CardHeader>
              ...
              {academicSummary ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 text-center group-hover/card:bg-slate-50/50 transition-colors rounded-3xl">
                  ...
                  <p className="text-sm font-medium text-slate-400 max-w-xs mx-auto">
                    Your evaluations are currently being processed by the
                    administration.
                  </p>
          ...
          <div className="flex flex-col items-center justify-center py-4">
            ...
            <div className="mt-8 px-6 py-3 rounded-2xl bg-white shadow-sm border border-slate-100">
              <p className="text-xs font-black text-slate-600 uppercase tracking-widest flex items-center gap-2">
                <TrendingUp className="h-3 w-3 text-emerald-500" /> Excellent
                tracking
              </p>
            </div>
          </div>
        ...
        {[
          ...
          <Link key={i} href={item.href} className="group">
            <div className="glass-panel h-full flex flex-col items-center justify-center p-8 transition-all duration-500 cursor-pointer border-transparent hover:border-white hover:bg-white hover:shadow-xl hover:-translate-y-2 relative overflow-hidden">
              ...
              <div
                className={`p-5 rounded-3xl ${item.bg}/50 mb-4 group-hover:scale-110 transition-transform duration-500 shadow-inner`}
              >
                <item.icon className={`h-8 w-8 ${item.color}`} />
              </div>
              <span className="font-black text-sm text-slate-700 uppercase tracking-wider group-hover:text-blue-600 transition-colors">
                {item.label}
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">
                Internal school updates and news.
              </p>
            </div>
          </div>
          <Button
            variant="ghost"
            className="text-blue-600 font-black text-[10px] uppercase tracking-widest hover:bg-blue-50 rounded-xl px-6"
            asChild
          >
            <Link href="/student/announcements">
              News Archive <ArrowRight className="ml-2 h-3 w-3" />
            </Link>
          </Button>
        </div>
