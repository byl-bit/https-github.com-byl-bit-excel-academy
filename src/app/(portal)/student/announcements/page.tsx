      ...
      <div className="space-y-6">
        {announcements.length > 0 ? (
          announcements.map((announcement) => (
            <Card
              key={announcement.id}
              className="overflow-hidden border-t-4 border-t-blue-500 hover:shadow-lg transition-all bg-white border-slate-100"
            >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <span
                        className={`text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider bg-blue-50 text-blue-700 border border-blue-100`}
                      >
                        {announcement.type}
                      </span>
              ...
              <div className="p-6 pt-4">
                ...
                {announcement.type === "event" && (
                  <div className="flex items-center gap-4 mt-4 pt-3 border-t border-slate-100">
                    ...
                    >
                      <ThumbsUp
                        className={`h-4 w-4 ${votes[String(announcement.id)]?.myVote === "like" ? "fill-blue-600" : ""}`}
                      />
