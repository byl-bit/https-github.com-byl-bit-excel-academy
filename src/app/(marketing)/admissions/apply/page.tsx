          ...
          <CardContent className="flex flex-col items-center gap-6 pb-12 pt-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-slate-600 px-4">
                Our admission team will review your data and call you within
            ...
            <Button
              asChild
              size="lg"
              className="rounded-full bg-slate-900 px-10 h-14 font-bold transition-all hover:scale-105 shadow-xl shadow-slate-900/10"
            >
        ...
        <div className="grid lg:grid-cols-[1fr_450px] gap-12 items-start">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-4 text-indigo-600">
                      <div className="w-8 h-8 rounded-full bg-indigo-50 flex items-center justify-center font-black text-sm">
                        2
                      </div>
                      <h3 className="font-black uppercase tracking-wider text-xs">
                        Student Information
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          id="familyFullName"
                          placeholder="Full guardian name"
                          required
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-4 text-purple-600">
                      <div className="w-8 h-8 rounded-full bg-purple-50 flex items-center justify-center font-black text-sm">
                        3
                      </div>
                      <h3 className="font-black uppercase tracking-wider text-xs">
                        Contact Details
                    ...
                    <div className="border-2 border-dashed border-slate-200 rounded-2xl p-8 text-center hover:border-blue-500 hover:bg-blue-50/50 transition-all cursor-pointer relative group">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-500 italic">
                          Please attach previous report cards or ID proof (Max
                          10MB)
                        </p>
                      </div>
                      {file && (
          ...
          <aside className="space-y-6 animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
            <div className="bg-white p-8 rounded-4xl shadow-xl shadow-slate-950/5 space-y-6">
              <h3 className="font-black text-slate-900 border-b border-slate-100 pb-4">
              ...
              <ul className="space-y-4">
                {[
                  {
                    title: "Review Period",
                    text: "Most applications are reviewed within 48 hours.",
                  },
                  {
                    title: "Interview",
                    text: "Selected students will be invited for an entrance interview.",
                  },
                  {
                    title: "Documentation",
                    text: "Original documents must be presented during registration.",
                  },
                ].map((item, i) => (
            ...
            <div className="bg-linear-to-br from-indigo-900 to-slate-950 p-8 rounded-4xl shadow-2xl text-white relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <p className="text-sm text-indigo-100/80 leading-relaxed">
                  Our support team is available Mon-Fri, 8AM to 5PM to help you
