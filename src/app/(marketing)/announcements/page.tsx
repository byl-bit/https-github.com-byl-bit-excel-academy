              ...
              <CardContent className="p-8 md:p-10 pt-6">
                ...
                <div className="flex items-center justify-between pt-8 border-t border-slate-50">
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <ThumbsUp
                        className={`h-4 w-4 ${votes[String(announcement.id)]?.myVote === "like" ? "fill-white" : ""}`}
                      />
                    ...
                    >
                      <ThumbsDown
                        className={`h-4 w-4 ${votes[String(announcement.id)]?.myVote === "dislike" ? "fill-white" : ""}`}
                      />
          ...
          {filteredAnnouncements.length === 0 && (
            <div className="text-center py-20 animate-in fade-in duration-1000">
              ...
              <p className="text-slate-500 font-light">
                We couldn't find any announcements matching your criteria. Try a
