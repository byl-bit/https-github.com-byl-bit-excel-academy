    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative py-24 md:py-32 bg-slate-950 text-white overflow-hidden">
        ...
        <div className="container relative z-10 px-6 mx-auto text-center max-w-4xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-sm font-bold text-cyan-200 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <p className="text-xl md:text-2xl text-cyan-100 leading-relaxed font-light animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200">
            The Excel Academy WDD Portal is more than just a system—it's a
            digital ecosystem designed to cultivate excellence, integrity, and
        ...
        <div className="container px-6 mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-slate-600 leading-relaxed mb-8">
                  We bridge the gap between traditional education and the
                  digital future. Our platform provides a seamless experience
                  for administration, faculty, and students to collaborate and
                ...
                {[
                  {
                    ...
                    desc: "Instant results & updates",
                    color: "blue",
                  },
                  {
                    icon: Globe,
                    title: "Online Library",
                    desc: "Digital resources 24/7",
                    color: "indigo",
                  },
                  {
                    icon: Shield,
                    title: "Secure Data",
                    desc: "Private & encrypted portal",
                    color: "purple",
                  },
                  {
                    icon: Target,
                    title: "Goal Oriented",
                    desc: "Track progress accurately",
                    color: "orange",
                  },
                ].map((item, i) => (
              ...
              <div className="pt-4">
                <Button
                  asChild
                  className="h-14 px-8 rounded-full bg-cyan-600 hover:bg-cyan-700 shadow-xl shadow-cyan-500/20 text-white font-bold transition-all hover:scale-105"
                >
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-linear-to-tr from-cyan-600 to-teal-600 rounded-5xl blur-2xl opacity-10 animate-pulse" />
              <div className="relative bg-white rounded-4xl border border-slate-200 p-8 shadow-2xl">
                <div className="space-y-6">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex gap-6 p-6 rounded-2xl border border-slate-50 hover:bg-slate-50 transition-colors"
                    >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center space-y-2">
                <h2 className="text-4xl md:text-5xl font-black text-cyan-600">
                  {stat.value}
                </h2>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="container px-6 mx-auto text-center max-w-3xl relative z-10">
          ...
          <h2 className="text-4xl font-black text-slate-900 mb-8">
            Guided by Ethics & Excellence
          </h2>
          <p className="text-2xl text-slate-600 font-light leading-relaxed italic">
            "Our mission is to provide an environment where every student feels
            valued, challenged, and supported in their journey toward academic
      ...
      <section className="py-24">
        <div className="container px-6 mx-auto">
          <div className="bg-linear-to-r from-cyan-600 to-navy-900 rounded-6xl p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-cyan-500/30">
            ...
            <div className="relative z-10 space-y-8 max-w-2xl mx-auto">
              ...
              <p className="text-xl text-cyan-100 font-light">
                Whether you are a prospective student, a dedicated parent, or an
                expert educator, there is a place for you at Excel Academy.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center pt-4">
                <Button
                  asChild
                  size="lg"
                  className="h-16 px-10 rounded-full bg-white text-cyan-600 hover:bg-slate-100 font-bold text-lg shadow-xl shadow-black/10 transition-all hover:scale-105"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="h-16 px-10 rounded-full border-2 border-white/40 text-white hover:bg-white/10 bg-transparent font-bold text-lg transition-all"
                >
