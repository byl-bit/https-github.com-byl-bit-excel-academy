          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="pt-4">
                <Button
                  asChild
                  className="h-14 px-8 rounded-full bg-blue-600 hover:bg-blue-700 shadow-xl shadow-blue-500/20 text-white font-bold transition-all hover:scale-105"
                >
            ...
            <div className="relative z-10 space-y-8 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center pt-4">
                <Button
                  asChild
                  size="lg"
                  className="h-16 px-10 rounded-full bg-white text-blue-600 hover:bg-slate-100 font-bold text-lg shadow-xl shadow-black/10 transition-all hover:scale-105"
                >
