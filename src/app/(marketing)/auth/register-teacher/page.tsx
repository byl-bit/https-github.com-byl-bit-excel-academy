      ...
      try {
        ...
        try {
          const users = JSON.parse(
            localStorage.getItem("excel_academy_users") || "[]",
          );
          users.push(newTeacher);
          localStorage.setItem("excel_academy_users", JSON.stringify(users));
        } catch (storeErr) {
          console.warn(
            "Quota exceeded in registration fallback, stripping photo.",
            storeErr,
          );
          try {
            const users = JSON.parse(
      ...
      <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50">
        <Card className="max-w-lg w-full shadow-2xl border-none glass-panel">
          <CardHeader className="text-center">
            ...
            <CardDescription className="font-bold text-slate-500 uppercase tracking-widest text-[10px] mt-2">
              Your Credentials
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-xs font-bold text-slate-500 text-center mb-8 leading-relaxed">
              Your application has been received. Our administration team will
              review and authorize your account shortly. You will be able to log
              in once your status is set to{" "}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button
                variant="outline"
                asChild
                className="h-12 rounded-xl border-slate-200 font-black uppercase text-xs tracking-widest hover:bg-slate-50"
              >
      ...
      <div className="container relative z-10 mx-auto flex items-center justify-center px-4 py-8">
        ...
        <CardHeader className="p-8 pb-4">
          ...
          <CardDescription className="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-2">
            Request secure access to the faculty portal
          </CardDescription>
        </CardHeader>
            ...
            >
              ...
              <div className="space-y-4 pt-2">
                ...
                >
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <p className="font-black text-slate-700 uppercase text-xs tracking-tight mb-1">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="h-10 rounded-xl font-black text-[10px] uppercase tracking-widest border-slate-200"
                  >
                    Choose File
                  </Button>
                </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 pt-4">
                ...
                <Button
                  variant="ghost"
                  asChild
                  className="h-14 px-8 rounded-xl font-bold text-slate-500 hover:bg-slate-100"
                >
