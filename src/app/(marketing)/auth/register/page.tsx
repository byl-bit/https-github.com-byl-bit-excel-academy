...
export default function RegisterPage() {
  ...
  const [successData, setSuccessData] = useState<{ studentId: string } | null>(
    null,
  );
          ...
          <CardContent className="space-y-6">
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 shadow-inner">
              ...
              <p className="text-[10px] text-slate-400 mt-4 text-center font-bold uppercase tracking-widest leading-relaxed">
                Please record this ID securely. It is your primary <br />{" "}
                identity for all institutional services.
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-3 pt-4">
              ...
              <Button
                asChild
                variant="outline"
                className="flex-1 h-14 rounded-xl border-slate-200 font-black uppercase text-xs tracking-widest hover:bg-slate-50"
              >
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center p-6 bg-slate-50 rounded-2xl border border-slate-100 border-dashed hover:border-cyan-500 transition-colors">
                  ...
                  <div className="flex-1 space-y-4 text-center md:text-left w-full">
                    <div>
                      <h4 className="font-black text-slate-700 uppercase text-xs tracking-tight mb-1">
                        Standard Passport Photo
                      </h4>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                        Recommended for identity verification
                      </p>
                    </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 mt-2 ml-1">
                    ...
                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                      Must correspond with official school registry records
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 pt-6 border-t border-slate-100">
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider leading-relaxed text-center">
                    ...
                    and corresponds to my official academic status at Excel
                    Academy.
                  </p>
                </div>
