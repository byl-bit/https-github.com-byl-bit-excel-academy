      ...
      <section className="relative py-24 md:py-32 bg-slate-950 text-white overflow-hidden">
        ...
        <div className="container relative z-10 px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto">
            A rigorous, internationally-aligned curriculum designed to develop
            critical thinking, creativity, and leadership skills in every
            student.
          </p>
        </div>
      </section>
        ...
        <div className="container px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              ...
              students while providing the support they need to succeed.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-slate-600">
                  Developing analytical skills and problem-solving abilities
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-slate-600">
                  Tailored instruction that meets each student at their level
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-slate-600">
                  Preparing students to thrive in an interconnected world with
        ...
        <div className="container px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Comprehensive education from early childhood through secondary
              school
            </p>
          </div>
            ...
            {[
              {
                ...
                grades: "KG 1-3",
                description:
                  "Building foundational skills through play-based learning and early literacy",
                icon: Users,
              ...
              },
              {
                ...
                grades: "Grades 5-8",
                description:
                  "Expanding knowledge with specialized subjects and critical thinking skills",
                icon: TrendingUp,
              ...
              },
              {
                ...
                grades: "Grades 9-10",
                description:
                  "Preparing for national examinations with rigorous academic preparation",
                icon: GraduationCap,
              ...
              },
              {
                ...
                grades: "Grades 11-12",
                description:
                  "Advanced studies in Natural Science, Social Science, or other streams",
                icon: Award,
              ...
              },
              {
                ...
                grades: "All Levels",
                description:
                  "Comprehensive support for national and international examinations",
                icon: Trophy,
              ...
              >
                <CardContent className="p-6">
                  <div
                    className={`w-14 h-14 ${level.color} rounded-full flex items-center justify-center mb-4`}
                  >
      ...
      <section className="py-16 bg-white">
        <div className="container px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              A comprehensive curriculum covering all essential areas of
              learning
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card
                key={index}
                className="border-none shadow-md hover:shadow-lg transition-all text-center group"
              >
                <CardContent className="p-6">
                  <subject.icon
                    className={`w-12 h-12 ${subject.color} mx-auto mb-3 group-hover:scale-110 transition-transform`}
                  />
